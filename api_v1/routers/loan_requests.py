...
@router.post("/loanrequests/", response_model=schemas.LoanRequest)
...
@router.get("/loanrequests/", response_model=list[schemas.LoanRequest])
...
@router.get("/loanrequests/{loanrequest_id}", response_model=schemas.LoanRequest)
...
@router.put('/loanrequests/{loanrequest_id}/', response_model=schemas.LoanRequest)
def update_loanrequest(loanrequest_id: int, loanrequest: schemas.LoanRequestUpdate, db: Session = Depends(get_db)):
    ...
    loanrequest_updated = crud.update_loanrequest(db, loanrequest_id, loanrequest)
